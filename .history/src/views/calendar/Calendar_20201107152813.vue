...
export default {
    ...
    methods: {
        ...
        changeShowDate(year, month) {
            ...
            for (let i = 1, j = 29; i < (6 - PreLastDay); i++, j++) {
                this.day.push(j + 1);
            }
            for (let i = 0; i < totalday; i++) {
                this.day.push(i + 1);
            }
            for (let i = 1; i <= (nextMonthDays.nextMonthFirstDay); i++) {
                this.day.push(i)
            }
            console.log(this.day)
        ...
        getPreMonthdays(year, month) {
            ...
            let lastMothLastDay = new Date(year, month, 0)
            return {
                lastMothLastDay.getDay(),
                month,
                year
            };
        ...
        getNextMonthdays(year, month) {
            ...
            nextMonthFirstDay = 7 - nextMonthFirstDay.getDay();
