...
export default {
    ...
    methods: {
        ...
        changeShowDate(year, month) {
            ...
            for (let i = 1, j = 29; i < (PreLastDay.lastMothLastDay1); i++, j++) {
                this.day.push(j + 1);
            }
            for (let i = 0; i < totalday; i++) {
                this.day.push(i + 1);
            }
            for (let i = 1; i <= (nextMonthDays.nextMonthFirstDay1); i++) {
                this.day.push(i)
            }
        ...
        getPreMonthdays(year, month) {
            ...
            let lastMothLastDay1 = 6 - lastMothLastDay.getUTCDay()
            console.log(lastMothLastDay)
            return {
                lastMothLastDay,
                lastMothLastDay1,
                month,
        ...
        getNextMonthdays(year, month) {
            ...
            let nextMonthFirstDay1 = 7 - nextMonthFirstDay.getUTCDay();
