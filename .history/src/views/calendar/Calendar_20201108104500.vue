...
<div class="Calendar">
    ...
    <div id="list" class="list">
        ...
        <div v-show="show_dialog.status">
            <Dialog v-model="show_dialog.status" type="confirm" title="新建日程" content="我是内容" @cancel="clickCancel()" @danger="clickDanger()" @confirm="clickConfirm" dangerText="Delete"></Dialog>
        </div>
    </div>
</div>
</template>
