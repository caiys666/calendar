...
export default {
    ...
    methods: {
        ...
        changeShowDate(year, month) {
            ...
            this.day = [];
            // console.log(this.DateCalendar.lastDay.getDate())
            // console.log(this.day)
            // console.log(this.weekdays[d].label)
            ...
            for (let i = 1, j = 29; i < (7 - PreLastDay); i++, j++) {
                this.day.push(j + 1);
            }
            for (let i = 0; i < totalday; i++) {
                this.day.push(i + 1);
            }
            for (let i = 1; i <= (7 - nextMonthDays.nextMonthFirstDay); i++) {
                this.day.push(i)
            }
            console.log(this.day)
        ...
        getPreMonthdays(year, month) {
            ...
            let lastMothLastDay = new Date(year, month, 0).getDay()
            return lastMothLastDay;
            // console.log("pre" + lastMothLastDay)
        },
        getNextMonthdays(year, month) {
            ...
            nextMonthFirstDay = nextMonthFirstDay.getDay();
