...
<div class="Calendar">
    ...
    <div class="list">
        ...
        <div v-show="show_dialog" class="show_dialog">
            <Dialog v-model="show_dialog" type="confirm" title="新建日程" content="我是内容" @cancel="clickCancel()" @danger="clickDanger()" @confirm="clickConfirm(value)" dangerText="Delete"></Dialog>
        </div>
    </div>
</div>
</template>
