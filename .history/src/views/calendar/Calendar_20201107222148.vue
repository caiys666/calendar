...
<div class="Calendar">
    ...
    <div id="list" class="list">
        <div :id="getID(item.index)" :class="{list_item}" v-for=" (item, index) in daylist" :key="index" @click="addDialog(index)">
            <div :class="{list_item_test:isactive === index ? true : false}"><span>{{ item.id }}</span></div>
