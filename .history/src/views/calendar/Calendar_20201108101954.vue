...
<div class="Calendar">
    ...
    <div id="list" class="list">
        <div class="list_item" v-for=" (item, index) in daylist" :key="index" @click="addDialog(index)" @mouseover="addClass(index)">
            <div :class="{itemtext,list_item_test:isactive === index ? true : false}"><span>{{ item.id }}</span></div>
            <div v-if="addClassTag  == index" class="list_item_dialog">+</div>
        </div>
