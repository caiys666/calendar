...
<div class="Calendar">
    ...
    <div class="list">
        ...
        <div v-show="show_dialog" class="show_dialog">
            <Dialog v-model="show_dialog" type="danger" title="我是标题" content="我是内容" v-on:cancel="clickCancel()" @danger="clickDanger()" @confirm="clickConfirm()" dangerText="Delete"></Dialog>
        </div>
    </div>
</div>
</template>
