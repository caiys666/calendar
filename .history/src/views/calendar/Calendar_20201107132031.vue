...
<div>
    <div class="header">
        <div class="header_left" @click="changeCheckDate('add')"></div>
        <div class="header_main" v-model="showCheckDate">{{showCheckDate}}</div>
        <div class="header_right" @click="changeCheckDate('reduce')"></div>
    </div>
    <div class="week">
...
export default {
    ...
    mounted() {
        ...
        console.log(dateobj.firstdd + dateobj.lastdd);
    },
};
</script>
...
.week {
    ...
    div {
        ...
        text-align: center;
        line-height: 40px;
        background-image: linear-gradient(to top, #fad0c4, #fad0c4);
        margin: 0 10px;
    }
}
